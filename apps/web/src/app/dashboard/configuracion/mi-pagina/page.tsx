...
export default function MiPaginaPage() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="space-y-2">
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl bg-white/[0.06] hover:bg-white/[0.10] border border-white/[0.09] text-white/60 hover:text-white text-[13px] transition-colors duration-150 disabled:opacity-40 flex items-center gap-2"
            >
      ...
      {/* Link actual */}
      <div className="bg-white/[0.03] border border-white/[0.10] rounded-2xl px-5 py-5">
        <p className="text-[11px] uppercase tracking-[0.15em] text-white/30 font-medium mb-3">Tu link actual</p>
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={copyLink}
            className="shrink-0 px-4 py-3 rounded-xl bg-amber-500 hover:bg-amber-400 text-black text-[13px] font-semibold transition-colors duration-150 flex items-center gap-2"
          >
            {copied ? (
          ...
          <a
            ...
            className="shrink-0 px-4 py-3 rounded-xl bg-white/[0.05] hover:bg-white/[0.10] border border-white/[0.08] text-white/50 hover:text-white text-[13px] transition-colors duration-150 flex items-center gap-2"
          >
